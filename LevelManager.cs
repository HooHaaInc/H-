            ...
            for (int x = 0; x < TileMap.MapWidth; x++)
            {
                for (int y = 0; y < TileMap.MapHeight; y++)
                {
				    ...
				    case "START":
					    ...
					    break;
				    case "DRUG":
						drugs.Add (new Drug (graphics, x, y));
					    break;
				    case "ENEMY":
						enemies.Add(new Enemy(graphics, x, y, 3));
                        break;
				    case "CHAIR":
						enemies.Add (new Enemy (graphics, x, y, 1));
					    break;
				    case "POT":
						enemies.Add (new Enemy (graphics, x, y, 2));
					    break;
				    case "PLATFORM":
						platforms.Add (new Platform (graphics, x, y));
					    break;
					}
